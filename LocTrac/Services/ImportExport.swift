...
struct Export: Codable {
    ...
    // Tolerant decoder for legacy backups missing activities/affirmations/trips/eventTypes
    ...
    init(locations: [Location], events: [Event], activities: [Activity], affirmations: [Affirmation], trips: [Trip], eventTypes: [EventTypeItem]) {
